...
STRING2 | STRING | COMMENT | INITIAL
...
fun yyAction0 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING;str := "";balancedstr := false; continue()))
fun yyAction1 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING2;continue()))
...
fun yyAction3 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm; (YYBEGIN STRING; str := !str ^ yytext; continue())
      end
...
fun yyAction9 (strm, lastMatch : yymatch) = (yystrm := strm;
      (raise Fail("String contians illegal use of backslash")))
fun yyAction10 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT;count := 1;continue()))
fun yyAction11 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT;count := !count + 1;continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction59(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction29(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction29(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ60(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction25(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction25(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ60(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction26(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction26(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction24(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction30(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ60(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction27(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction27(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ89(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ60(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyAction59(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction33(strm, yyNO_MATCH)
                      else yyQ60(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ60(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = #"`"
...
fun yyQ99 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction19(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ99(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            else if inp < #"0"
...
in
  (case (!(yyss))
   of STRING2 => yyQ0(!(yystrm), yyNO_MATCH)

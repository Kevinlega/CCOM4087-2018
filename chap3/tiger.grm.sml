...
\\001\000\006\000\070\000\000\000\
...
\\076\000\015\000\025\000\016\000\024\000\017\000\023\000\018\000\022\000\
\\019\000\021\000\020\000\020\000\021\000\019\000\022\000\018\000\
\\023\000\017\000\024\000\016\000\025\000\015\000\026\000\014\000\000\000\
\\077\000\027\000\012\000\000\000\
\\078\000\000\000\
\\079\000\000\000\
\\080\000\000\000\
...
\\019\000\021\000\020\000\020\000\021\000\019\000\022\000\018\000\
\\023\000\017\000\024\000\016\000\025\000\015\000\026\000\014\000\000\000\
\\088\000\008\000\034\000\000\000\
\\089\000\000\000\
\\090\000\000\000\
\\091\000\000\000\
\\092\000\000\000\
...
\\099\000\000\000\
\\100\000\000\000\
\\101\000\042\000\030\000\043\000\029\000\044\000\028\000\000\000\
\\102\000\000\000\
\\103\000\000\000\
\\104\000\015\000\025\000\016\000\024\000\017\000\023\000\018\000\022\000\
\\019\000\021\000\020\000\020\000\021\000\019\000\022\000\018\000\
\\023\000\017\000\024\000\016\000\025\000\015\000\026\000\014\000\000\000\
\\105\000\015\000\025\000\016\000\024\000\017\000\023\000\018\000\022\000\
\\019\000\021\000\020\000\020\000\021\000\019\000\022\000\018\000\
\\023\000\017\000\024\000\016\000\025\000\015\000\026\000\014\000\000\000\
...
\\019\000\021\000\020\000\020\000\021\000\019\000\022\000\018\000\
\\023\000\017\000\024\000\016\000\025\000\015\000\026\000\014\000\000\000\
\\110\000\005\000\064\000\000\000\
\\111\000\000\000\
\\112\000\000\000\
\"
...
\\027\000\036\000\001\000\001\000\
\\048\000\047\000\046\000\044\000\
\\045\000\043\000\042\000\041\000\
\\040\000\039\000\038\000\037\000\
\\049\000\022\000\002\000\003\000\
\\004\000\018\000\014\000\054\000\
\\001\000\030\000\029\000\050\000\
\\001\000\019\000\011\000\016\000\
\\001\000\032\000\001\000\010\000\
\\056\000\015\000\005\000\006\000\
\\007\000\034\000\055\000\031\000\
\\001\000\033\000\051\000\021\000\
\\058\000\017\000\012\000\001\000\
\\057\000\001\000\007\000\013\000\
\\008\000\035\000\052\000\059\000\
\\009\000\060\000\020\000\001\000\
\\053\000\000\000"
val gotoT =
"\
\\001\000\002\000\002\000\073\000\006\000\001\000\000\000\
\\000\000\
...
\\000\000\
\\005\000\011\000\000\000\
\\001\000\044\000\004\000\043\000\006\000\001\000\000\000\
\\005\000\011\000\000\000\
\\005\000\011\000\000\000\
\\000\000\
\\001\000\031\000\003\000\045\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\009\000\067\000\010\000\056\000\000\000\
\\000\000\
\\000\000\
\\005\000\011\000\000\000\
\\005\000\011\000\000\000\
...
LET1left, _)) :: rest671)) => let val  result = MlyValue.ntVOID (fn _
 => ( let val  (declist as declist1) = declist1 ()
...
|  ( 11, ( ( _, ( MlyValue.ntVOID exp3, _, exp3right)) :: _ :: ( _, ( 
...
|  ( 22, ( ( _, ( _, GE1left, GE1right)) :: rest671)) => let val  
result = MlyValue.ntVOID (fn _ => ())
 in ( LrTable.NT 4, ( result, GE1left, GE1right), rest671)
end
|  ( 23, ( ( _, ( _, AND1left, AND1right)) :: rest671)) => let val  
result = MlyValue.ntVOID (fn _ => ())
 in ( LrTable.NT 4, ( result, AND1left, AND1right), rest671)
end
|  ( 24, ( ( _, ( _, OR1left, OR1right)) :: rest671)) => let val  
result = MlyValue.ntVOID (fn _ => ())
...
rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val  (
typefield as typefield1) = typefield1 ()
 val  (typefields as typefields1) = typefields1 ()
